      ...
      try {
        ...
        switch (query) {
          case "":
            // 뉴스 API 주소 전체 주제
            const response = await axios.get(
              `https://newsapi.org/v2/top-headlines?country=kr&apiKey=a4b3f1f8d23c427fa2ea193135bdd2ed`
            );
          ...
          case "&category=business":
            ...
            const response_business = await axios.get(
              `https://newsapi.org/v2/top-headlines?country=kr${query}&apiKey=a4b3f1f8d23c427fa2ea193135bdd2ed`
            );
