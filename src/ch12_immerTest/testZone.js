...
const TestZone = () => {
  ...
  const sampleData = [
    { id: 1, name: "lhj", age: "22" },
    { id: 2, name: "lhj2", age: "22" },
    { id: 3, name: "lhj3", age: "33" },
    { id: 4, name: "lhj4", age: "44" },
  ];
  // 기본 문법 살펴보기.
  ...
  const nextState2 = produce(array, (draft) => {
    draft.class = { name: "lhj" };
  });

  //데이터 추가2
  const nextState3 = produce(sampleData, (draft) => {
    draft.push({ id: 2, name: "lhj2", age: "28" });
  });
  ...
  //splice(1,1) : 1이라는 인덱스 부터, 1개 요소를 삭제를 하는 내장함수.
  //데이터 제거 1, 제거한 원소를 가지는 배열을 출력.
